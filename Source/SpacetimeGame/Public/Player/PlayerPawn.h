...
class UPlayerHoldComponent;
class AFollowActor;
struct FInputBindingHandle;

UCLASS()
class SPACETIMEGAME_API APlayerPawn : public APawn
{
	GENERATED_BODY()
...
#pragma region INPUT
	...
	FInputBindingHandle* InteractStartedBinding;
	FInputBindingHandle* InteractCompletedBinding;
...
#pragma region INTERACT
	...
	UPROPERTY(EditAnywhere)
	UPlayerHoldComponent* PlayerHold;

	UFUNCTION()
	void InitialisePlayerHold();
